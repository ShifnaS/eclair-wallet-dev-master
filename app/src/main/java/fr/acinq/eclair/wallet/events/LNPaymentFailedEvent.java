...
public class LNPaymentFailedEvent {
  ...
  public LNPaymentFailedEvent(final String paymentHash, final String paymentDescription, final boolean isSimple, final String simpleMessage, final ArrayList<LightningPaymentError> errors,String invoiceId) {
