...
public class Payment {
  ...
  @Generated(hash = 278341522)
  public Payment(Long id, @NotNull PaymentType type, @NotNull PaymentDirection direction, @NotNull String reference, String invoice_id, String recipient,
                 String preimage, String paymentRequest, String localChannelId, String serializedRoute, String description, int confidenceBlocks, int confidenceType,
                 String txPayload, PaymentStatus status, @NotNull Date created, Date updated, String lastErrorCause, long amountRequestedMsat, long amountSentMsat,
                 long amountPaidMsat, long feesPaidMsat) {
      this.id = id;
      this.type = type;
