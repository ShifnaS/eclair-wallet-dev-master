...
public interface Constants {
  ...
  String URL_GETSCHEDULE_DETAILS=ApiUrl.BASE_URL+"/invoice/getschedulestsdetails/";
  String URL_CANCEL_PAYMENT=ApiUrl.BASE_URL+"/invoice/cancelpayment/";

  String URL_NOTIFICATION_LIST=ApiUrl.BASE_URL+"/invoice/getnotificationlist/";
